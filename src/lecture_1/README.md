Supervised learning is a machine learning algorithm that can map a dataset of inputs and outputs, finding a function that transforms the input into the corresponding output value
